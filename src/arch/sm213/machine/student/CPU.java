    ...
    switch (insOpCode.get()) {
      ...
      case 0x6: // ALU ................... 6-sd
        switch (insOp0.get()) {
          ...
          case 0xf: // gpc ............... 6fpr
            int o = insOp1.get()*2 +pc.get();
            reg.set(insOp2.get(), o);
            break;
      ...
      case 0xc: // j o(rr) ............... crpp  (pp = o / 2)
        int f = (insOpImm.getUnsigned()*2) + reg.get(insOp0.get());
        pc.set(f);
        break;
